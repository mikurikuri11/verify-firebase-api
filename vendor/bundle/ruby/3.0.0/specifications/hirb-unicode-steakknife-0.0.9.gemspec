# -*- encoding: utf-8 -*-
# stub: hirb-unicode-steakknife 0.0.9 ruby lib

Gem::Specification.new do |s|
  s.name = "hirb-unicode-steakknife".freeze
  s.version = "0.0.9"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["steakknife".freeze, "miaout17".freeze]
  s.cert_chain = ["gem-public_cert.pem".freeze]
  s.date = "2019-09-01"
  s.description = "Unicode support for hirb".freeze
  s.email = ["barry.allard@gmail.com".freeze, "miaout17 at gmail dot com".freeze]
  s.homepage = "".freeze
